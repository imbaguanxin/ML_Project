    ...
    \begin{enumerate}
        ...
        \begin{itemize}
            ...
            \begin{enumerate}
                ...
                As shown in the graph, we should use Gini impurity function as our loss function and the best number of estimators is $1400$.
                ...
                \begin{minipage}{0.4\textwidth}
                    ...
                    The regularization strength, C, was also tested with floats ranging from $1$ to $30.0$ to find the best value. The best hyperparameter $C = 13.0$ and $degree = 4$, with accuracy $= 0.792$
                \end{minipage}
                \begin{minipage}{0.5\textwidth}
                    \begin{center}
            ...
            \begin{center}
                \begin{tabular}{|c|c|}
                    \hline
                    LR&C = $6.8$, penalty = $l_2$\\ \hline
                    KNN& $k = 4$\\ \hline
                    RT& Loss Function = gini, n\_estimators = $1400$\\ \hline
                    SVM& Kernel = poly, degree = $4$, C = $13.0$\\ \hline
                \end{tabular}
            \end{center}
        ...
        \begin{itemize}
            ...
            \begin{enumerate}
                ...
                We tried out different values of $k$, ranging from $2$ to $30$ to find the best value of $k$.The best $k$ is 5.
                % \begin{figure}[h!]
                %     \centering
                ...
                \begin{minipage}{.4\textwidth}
                    ...
                    The best hyperparameter we have is $kernel = poly, C = 1.0$ and $degree = 9$.
                \end{minipage}
                \begin{minipage}{.4\textwidth}
            ...
            \begin{center}
                \begin{tabular}{|c|c|}
                    \hline
                    LR&C = 0.9, penalty = $l_2$\\ \hline
                    KNN& $k = 5$\\ \hline
                    RT& Loss Function = gini, n\_estimators = 600\\ \hline
                    SVM& Kernel = poly, degree = 9, C = 1\\ \hline
                \end{tabular}
            \end{center}
