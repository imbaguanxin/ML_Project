    ...
    \begin{enumerate}
        ...
        \begin{itemize}
            ...
            \begin{figure}[h!]
                \begin{subfigure}[h]{0.5\linewidth}
                    \centering
                    \includegraphics[width=0.5\linewidth, scale=0.5]{../data_set/moeimouto-faces/074_daidouji_tomoyo/face_795_301_69.png}
                    \caption{Meirin Ri labeled as Daidouji Tomoyo}
                \end{subfigure}
                \begin{subfigure}[h]{0.5\linewidth}
                    \centering
                    \includegraphics[width=0.5\linewidth, scale=0.5]{../data_set/moeimouto-faces/074_daidouji_tomoyo/face_451_275_121.png}
